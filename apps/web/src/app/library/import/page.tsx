...
const formSchema = z.object({
  ...
  bookmarkFile: z
    ...
    .refine(
      (file) => file.type === "application/json" || file.name.endsWith(".html"),
      {
...
export default function ImportBookmarksPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/import-bookmarks`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
  ...
  return (
    <div className="container mx-auto px-2 py-8">
      <h1 className="mb-6 font-bold text-3xl">Import Bookmarks</h1>
      <p className="mb-8 text-muted-foreground">
        Upload your Chrome bookmarks file (bookmarks.html) to import your
        bookmarks.
      </p>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Comma-separated list of domains to import. Only bookmarks
                    whose URL hostname matches any of these domains will be
                    imported.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field: { value, onChange, ...field } }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Upload your Chrome bookmarks file (bookmarks.html) or
                    exported bookmarks JSON file.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
